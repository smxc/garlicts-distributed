...
public class RmiPlugin extends DistributedPlugin {
	...
	public void register() {
		...
		Class<?> rmiProviderTemplateClass = ClassUtil.loadClass("com.garlicts.plugin.distributed.rmi.RmiProviderTemplate");
		Class<?> rmiConsumerTemplateClass = ClassUtil.loadClass("com.garlicts.plugin.distributed.rmi.RmiConsumerTemplate");
		try {
